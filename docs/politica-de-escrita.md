...
**nenhum teste depende de um contrato específico** — a escolha é distribuída por hash entre os 564
vigentes da base (11/09/2026) e reservada por teste, então remover qualquer contrato afeta no máximo os testes
que o escolhiam.
